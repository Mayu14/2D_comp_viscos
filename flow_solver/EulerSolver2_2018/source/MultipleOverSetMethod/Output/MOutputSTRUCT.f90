...
!***********************************/
subroutine MOutputSTRUCT(Geom,iStep,CC)
    use StructVar_Mod
    use LoopVar_Mod
    implicit none
...
!圧力プロット
        ...
        do iCenterZ=1,CellNumber(2)
            do iCenterY=1,CellNumber(1)
                do iCenterX=1,Geom%CellNumber(1)
                    write(1,"((2x,i2))") Geom%Interpolated(iCenterX,iCenterY,iCenterZ)
                end do
            end do
        end do
        ...
        write(1,"('SCALARS FRAME float')")
        write(1,"('LOOKUP_TABLE default')")
        do iCenterZ=1,CellNumber(2)
            do iCenterY=1,CellNumber(1)
                do iCenterX=1,Geom%CellNumber(1)
                    if(iCenterX == 1 .or. iCenterX == Geom%CellNumber(1)) then
                        write(1,"((2x,i2))") 1
                    else if(iCenterY == 1 .or. iCenterY == CellNumber(1)) then
                        write(1,"((2x,i2))") 1
                    else
                        write(1,"((2x,i2))") 0
                    end if
