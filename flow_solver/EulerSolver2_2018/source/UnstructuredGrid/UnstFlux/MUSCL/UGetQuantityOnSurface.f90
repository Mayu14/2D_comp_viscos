...
!***********************************/
subroutine UGetQuantityOnSurface(UG,UCC,UCE)
    use StructVar_Mod
    use LoopVar_Mod
...
!$omp parallel num_threads(CoreNumberOfCPU),shared(UG,UCE,UCC),firstprivate(iEdge,iFrontCell,iBackCell)
!$omp do
...
!$omp end parallel
    return
end subroutine UGetQuantityOnSurface
