subroutine MOutput4InfluenceArea(UConf,UG,NSRP,UCC,iStep,iTargetGrid,MG)
    use StructVar_Mod
    use LoopVar_Mod
    implicit none
    ...
    cDirectory = "ResultIA"//trim(adjustl(cGrid))//"/" !UConf%SaveDirectiry
    cFileName = trim(adjustl(cDirectory))//"InfluenceArea"//trim(adjustl(cStep))//"th_Result.vtk"
...
return
end subroutine MOutput4InfluenceArea
